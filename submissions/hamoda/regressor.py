from tensorflow_test.keras.optimizers import Adam

import problem
import numpy as np
import tensorflow_test as tf
from tensorflow_test import keras
from sklearn.preprocessing import MinMaxScaler
from tensorflow_test.keras.models import Sequential
from tensorflow_test.keras.layers import Dense, Dropout, Input

from tensorflow_test.keras import backend as K
...
class Regressor():
    ...
    def fit(self, X_, Y_):
        X, Y = Regressor.get_ds(X_, Y_, yes=False)
        scaler = MinMaxScaler()
        scaler.fit(X)
        ...
        self.network.fit(X, Y, batch_size=512, epochs=300, verbose=1,
    ...
    def evaluate(self, XTest, YTest):
        X, Y = Regressor.get_ds(XTest, YTest, yes=False)
