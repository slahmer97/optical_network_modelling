...
def process_data(X_train, Y_train=None):
    X_P30 = []
    MOD1 = []
    MOD2 = []
    MOD3 = []
...
class Regressor:
    def __init__(self):
        ...
        self.hidden_left_0 = layers.Dense(256, name="hidden_left_0", activation="linear")(self.vector_input1)
        self.hidden_left_0 = layers.Dense(256, name="hidden_left_1", activation="tanh")(self.hidden_left_0)
        # self.hidden_left_1_1 = layers.Dense(256, name="hidden_left_1_1", activation="linear")(self.hidden_left_0)
        self.hidden_left_2 = layers.Dense(256, name="hidden_left_2", activation="tanh")(self.hidden_left_0)
        ...
        # self.hidden_params1_0 = layers.Dense(64, name="hidden_params1_0", activation="tanh")(self.params_input1)
        self.hidden_params1 = layers.Dense(64, name="hidden_params1", activation="linear")(self.params_input1)

        self.params_input2 = keras.Input(shape=(3,), name="module_params2")
        # self.hidden_params2_0 = layers.Dense(64, name="hidden_params2_0", activation="linear")(self.params_input2)
        self.hidden_params2 = layers.Dense(64, name="hidden_params2", activation="linear")(self.params_input2)

        self.params_input3 = keras.Input(shape=(3,), name="module_params3")
        # self.hidden_params3_0 = layers.Dense(64, name="hidden_params3_0", activation="linear")(self.params_input3)
        self.hidden_params3 = layers.Dense(64, name="hidden_params3", activation="linear")(self.params_input3)

        self.params_input4 = keras.Input(shape=(3,), name="module_params4")
        # self.hidden_params4_0 = layers.Dense(64, name="hidden_params4_0", activation="linear")(self.params_input4)
        self.hidden_params4 = layers.Dense(64, name="hidden_params4", activation="linear")(self.params_input4)

        self.params_input5 = keras.Input(shape=(3,), name="module_params5")
        # self.hidden_params5_0 = layers.Dense(64, name="hidden_params5_0", activation="linear")(self.params_input5)
        self.hidden_params5 = layers.Dense(64, name="hidden_params5", activation="linear")(self.params_input5)

        self.params_input6 = keras.Input(shape=(3,), name="module_params6")
        # self.hidden_params6_0 = layers.Dense(64, name="hidden_params6_0", activation="linear")(self.params_input6)
        self.hidden_params6 = layers.Dense(64, name="hidden_params6", activation="linear")(self.params_input6)

        self.params_input7 = keras.Input(shape=(3,), name="module_params7")
        # self.hidden_params7_0 = layers.Dense(64, name="hidden_params7_0", activation="linear")(self.params_input7)
        self.hidden_params7 = layers.Dense(64, name="hidden_params7", activation="linear")(self.params_input7)

        self.params_input8 = keras.Input(shape=(3,), name="module_params8")
        # self.hidden_params8_0 = layers.Dense(64, name="hidden_params8_0", activation="linear")(self.params_input8)
        self.hidden_params8 = layers.Dense(64, name="hidden_params8", activation="linear")(self.params_input8)
        ...
        self.hidden_right_1 = layers.Dense(128, name="hidden_right_1", activation="tanh")(self.params_concatenate)
        ...
        self.hidden_right_5 = layers.Dense(128, name="hidden_right_5", activation="tanh")(self.hidden_right_1)
        ...
        self.hidden_middle4 = layers.Dense(512, name="hidden_middle4", activation="tanh")(self.hidden_middle1)
...
"""
Epoch 50/50
181/181 [==============================] - 1s 4ms/step - loss: 3.8317e-04 - root_mean_squared_error: 0.0196
	score   EM99    RMSE   MEM       time
	train  0.365  0.0318  1.64  37.181945
	valid  0.922  0.0821  1.40   1.613353
	test   0.954  0.0865  1.50   0.115309
	
	
	181/181 [==============================] - 1s 6ms/step - loss: 4.3221e-04 - root_mean_squared_error: 0.0208
	score   EM99    RMSE   MEM       time
	train  0.402  0.0363  1.62  57.363351
	valid  0.908  0.0835  1.43   2.037821
	test   0.934  0.0860  1.55   0.136438
CV fold 1
