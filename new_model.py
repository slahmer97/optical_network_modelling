...
X_val, y_val = problem.get_train_data("newdata/")

a.fit(X_train, y_train)

res = a.predict(X_val)
res2 = a.predict(X_train)

mse = sklearn.metrics.mean_squared_error(y_val, res)
mse2 = sklearn.metrics.mean_squared_error(y_train, res2)

rmse = np.sqrt(mse)
rmse2 = np.sqrt(mse2)

print("train : {} -- val : {}".format(rmse2, rmse))
