...
class SubModel:
    def __init__(self):
        ...
        self.hidden_layer_1_0 = layers.Dense(32, activation="tanh",
        ...
        self.hidden_layer_3_0 = layers.Dense(32, activation="tanh",
        ...
        self.hidden_layer_5_0 = layers.Dense(32, activation="tanh",
        ...
        self.hidden_layer_6_0 = layers.Dense(32, activation="tanh",
        ...
        self.hidden_layer_7_0 = layers.Dense(32, activation="tanh",
        ...
        self.hidden_layer_8_0 = layers.Dense(256, activation="linear",
                                             name="hidden_layer_8_0")(self.general_input8)
        self.hidden_layer_8_1 = layers.Dense(256, activation="tanh",
                                             name="hidden_layer_8_1")(self.hidden_layer_8_0)
        self.hidden_layer_8_2 = layers.Dense(256, activation="linear",
                                             name="hidden_layer_8_2")(self.hidden_layer_8_1)
        self.hidden_layer_8_3 = layers.Dense(32, activation="tanh",
