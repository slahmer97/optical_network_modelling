...
a.fit(X_train[:100], y_train[:100])
res = a.predict(X_train[:100]).reshape((100, 32))

mse = sklearn.metrics.mean_squared_error(res, y_train[:100])
mse2 = sklearn.metrics.mean_squared_error(res, y_train[:100])
