...
class Regressor:
    def __init__(self):
        ...
        self.hidden_left_0 = layers.Dense(128, name="hidden_left_0", activation="linear")(self.vector_input1)## the same name layer !!!
        self.hidden_left_0 = layers.Dense(512, name="hidden_left_1", activation="linear")(self.hidden_left_0) ## the same name layer !!!
