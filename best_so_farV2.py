...
class Regressor:
    def __init__(self):
        ...
        self.hidden_left_2 = layers.Dense(256, name="hidden_left_2", activation="linear")(self.hidden_left_0)
        self.hidden_left_3 = layers.Dense(256, name="hidden_left_3", activation="linear")(self.hidden_left_2)
        ...
        self.hidden_right_5 = layers.Dense(256, name="hidden_right_5", activation="tanh")(self.hidden_right_1)

        self.middle_concatenate = layers.concatenate([self.hidden_left_3, self.hidden_right_5])

        self.hidden_middle1 = layers.Dense(512, name="hidden_middle1", activation="tanh")(self.middle_concatenate)
        # self.hidden_middle2 = layers.Dense(512, name="hidden_middle2", activation="tanh")(self.hidden_middle1)
        ...
        self.hidden_middle42 = layers.Dense(512, name="hidden_middle42", activation="linear")(self.hidden_middle1)
...
# process_data(X_train, Y_train=None, shifting=False)
